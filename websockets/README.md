...
Pending exchange transactions for early visibility, reconciled against confirmed trades by tx hash. Two subscriptions (fits the Free plan). *Quiet until the production mempool source is provisioned.*
```bash
